...
const orderSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['pending', 'processing', 'shipped', 'delivered', 'refunded', 'canceled'], default: 'pending' },
  paymentStatus: { type: String, enum: ['cod', 'paid', 'failed', 'unpaid'], default: 'cod' },
  shippingAddress: {
